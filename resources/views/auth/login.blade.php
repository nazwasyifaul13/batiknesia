...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        :root {
            --bg-left-light: linear-gradient(145deg, #c4a747 0%, #e8d4a8 50%, #f5e6c8 100%);
            --bg-right-light: rgba(255,255,255,0.85);
        ...
        :root {
            --bg-left-dark: linear-gradient(145deg, #0a0805 0%, #1a1208 100%);
            --bg-right-dark: rgba(0,0,0,0.55);
        ...
        .role-card .card-content i {
            font-size: 14px;
            color: var(--text-muted);
            margin-right: 8px;
        }
        .role-card .card-content span {
            font-size: 12px;
            font-weight: 600;
            color: var(--text-primary);
        }
        .role-card input:checked + .card-content i {
            color: var(--accent);
        }
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-left">
            <div class="left-content">
                <div class="logo-left">
                    <img src="{{ asset('images/logos/logo-batik.png') }}" alt="Batiknesia Logo" class="logo-img" onerror="this.src='https://placehold.co/130x130?text=Batik'">
                    <h2>BATIKNESIA</h2>
                    <p>WARISAN NUSANTARA</p>
                </div>
                <div class="welcome-text">
                    <h3>Selamat Datang!</h3>
                    <p>Masuk untuk menjelajahi keindahan batik Nusantara</p>
                </div>
                <div class="feature-list">
                    <div class="feature-item"><i class="fas fa-magic"></i><span>Virtual Try On dengan AI</span></div>
                    <div class="feature-item"><i class="fas fa-graduation-cap"></i><span>Edukasi Motif Batik</span></div>
                    <div class="feature-item"><i class="fas fa-store"></i><span>Koleksi Batik Asli</span></div>
                    <div class="feature-item"><i class="fas fa-truck"></i><span>Lacak Pesanan Real-time</span></div>
                </div>
            </div>
        </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="email" name="email" placeholder="admin@batiknesia.com" required>
                        </div>
                    </div>
